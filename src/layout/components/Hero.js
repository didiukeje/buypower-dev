    ...
    return (
        <>
          ...
          <div className="container position-relative" data-aos="fade-up" data-aos-delay="100">
            <div className="row justify-content-left" id="api">
              ...
              <div className="col-xl-3 col-lg-3 text-left" id="green-yellow">
                <img id="header-img0" alt="..." src={require("../assets/img/header/green-frame.svg").default} />
                <img id="header-img1" alt="..." src={require("../assets/img/header/yellow-frame.svg").default} />
              </div>
            </div>
