            ...
            <div className="container" data-aos="fade-up">
              ...
              <div className="row pt-3 justify-content-between">
                <div className="card border-light why-card col-lg-4 col-md-4 d-flex align-items-stretch" data-aos="zoom-in"
                  ...
                  <div className="card-body">
                    <div className="card-icon bg-sec">
                      <img alt="..." src={require("../assets/img/icons/chart.svg").default} />
                    </div>
                ...
                <div className="card border-light why-card col-lg-4 col-md-4 d-flex align-items-stretch" data-aos="zoom-in"
                  ...
                  <div className="card-body">
                    <div className="card-icon bg-sec">
                      <img width="17" alt="..." src={require("../assets/img/icons/percent.svg").default} />
                    </div>
                    <h5 className="card-title">
                      98.5% Percent Uptime
                    </h5>
                ...
                <div className="card border-light why-card col-lg-4 col-md-4 d-flex align-items-stretch" data-aos="zoom-in"
                  ...
                  <div className="card-body">
                    <div className="card-icon bg-sec">
                      <img alt="..." src={require("../assets/img/icons/file.svg").default} />
                    </div>
                    <h5 className="card-title">
